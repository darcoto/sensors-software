const char INTL_WLAN_DATEN[] PROGMEM = "WLAN Daten Кирилица";
...
const char INTL_BASICAUTH[] PROGMEM = "BasicAuth";
const char INTL_AUTO_UPDATE[] PROGMEM = "Auto Update";
const char INTL_DISPLAY[] PROGMEM = "Display";
const char INTL_WEITERE_APIS[] PROGMEM = "Weitere APIs ОЩЕ";
